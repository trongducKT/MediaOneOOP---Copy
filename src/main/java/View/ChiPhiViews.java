...
public class ChiPhiViews extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ChiPhiViews
     */
    public ChiPhiViews() {
        initComponents();
        this.setLocationRelativeTo(null);
        PanelView.setLayout(new BorderLayout());
//        PanelView.add(new ChiPhiNhanVien());
    }
    ...
    private void BtnSanPhamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSanPhamActionPerformed
        ...
        PanelView.removeAll();
        PanelView.setLayout(new BorderLayout());
        PanelView.add(new ChiPhiSanPham());
        PanelView.validate();
        PanelView.repaint();
...
//            java.util.logging.Logger.getLogger(ChiPhiViews.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new ChiPhiViews().setVisible(true);
//            }
//        });
//    }
